...
public class LogicalExpression {
    ...
    public static Stack<String> Stacks_sym = new Stack<String>();
    private static boolean Final_Value;
    ...
    public boolean solve_expressions(HashMap<String, Boolean> model) {
        ...
        if (this.getUniqueSymbol() != null) {
            Stacks_sym.push(this.getUniqueSymbol());
        } else {
            LogicalExpression nextExpression;

            Stacks_sym.push(this.getConnective());
            ...
            Final_Value = popUniqueSymbolsAndEvaluateResult(model);
        }
        return Final_Value;
    }
    ...
    private boolean popUniqueSymbolsAndEvaluateResult(HashMap<String, Boolean> model) {
        ...
        if (result) { // push evaluated result again on top of stack for further use
            Stacks_sym.push(TRUE);
        } else {
            Stacks_sym.push(FALSE);
        }
